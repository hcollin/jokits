...
var interceptorEngine_1 = require("./engineParts/interceptorEngine");
var subscriberEngine_1 = require("./engineParts/subscriberEngine");
var atomEngine_1 = require("./engineParts/atomEngine");
var serviceEngine_1 = require("./engineParts/serviceEngine");
var stateEngine_1 = require("./engineParts/stateEngine");
...
})(JokiServiceEvent = exports.JokiServiceEvent || (exports.JokiServiceEvent = {}));
;
function createJoki(options) {
    ...
    var INTERCEPTOR = interceptorEngine_1["default"]();
    var SUBSCRIBER = subscriberEngine_1["default"]();
    var ATOMS = atomEngine_1["default"]();
    var SERVICES = serviceEngine_1["default"]();
    var STATEMACHINE = stateEngine_1["default"]();
    // MAIN FUNCTIONS
